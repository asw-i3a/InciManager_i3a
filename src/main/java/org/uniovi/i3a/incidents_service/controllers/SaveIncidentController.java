...
public class SaveIncidentController extends AbstractIncidentController {
    ...
    /**
     * Saves an object in the data base. If the object already exists will update the new fields.
     * 
	...
	return new ResponseEntity<String>(new JSONObject(responseMap).toString(), responseStatus);
    }
}
